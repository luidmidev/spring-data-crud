...
public class JpaSearchOptions<M> {
     ...
     * @return this
     */
    public JpaSearchOptions<M> operator(@NotNull Predicate.BooleanOperator operator) {
     ...
     * @return this
     */
    public JpaSearchOptions<M> specification(@NotNull Specification<M> specification) {
        if (hasInvoked) {
     ...
     * @return this
     */
    public JpaSearchOptions<M> and(@NotNull Specification<M> specification) {
     ...
     * @return this
     */
    public JpaSearchOptions<M> or(@NotNull Specification<M> specification) {
     ...
     * @return this
     */
    public JpaSearchOptions<M> join(@NotNull String join) {
        this.joins.add(join);
        return this;
    }
     ...
     * @return this
     */
    public JpaSearchOptions<M> joins(@NotNull String @NotNull ... joins) {

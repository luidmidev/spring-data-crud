 ...
 * <p>
 * This service extends {@link StandardReadService} for reading operations, {@link StandardWriteService} for write operations,
 ...
 */
public interface StandardCrudService<M extends Persistable<ID>, D, ID, R extends ListCrudRepository<M, ID> & PagingAndSortingRepository<M, ID>> extends
